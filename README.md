...
[![ColorGlass Preview](https://tu-usuario.github.io/tu-repo/screenshot.png)](https://color-theme-swart.vercel.app)
...
* **Animaciones Premium:** Transiciones fluidas impulsadas por `framer-motion` (vistas dinámicas y gestos).
* **Persistencia de Datos:** Guarda tus paletas favoritas en una biblioteca personal (utiliza `LocalStorage`).
